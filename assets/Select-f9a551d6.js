...
`,[_("scrollbar",`
 ...
 `,[Rt({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),Yn=Object.assign(Object.assign({},he.props),{to:it.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),so=re({name:"Select",props:Yn,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:o,namespaceRef:l,inlineThemeDisabled:d}=xt(e),c=he("Select","-select",Xn,cn,e,n),b=T(e.defaultValue),a=J(e,"value"),R=ut(a,b),w=T(!1),m=T(""),S=k(()=>{const{valueField:t,childrenField:u}=e,x=Un(t,u);return Tn(v.value,x)}),O=k(()=>Gn(ee.value,e.valueField,e.childrenField)),$=T(!1),p=ut(J(e,"show"),$),F=T(null),L=T(null),C=T(null),{localeRef:y}=Ft("Select"),U=k(()=>{var t;return(t=e.placeholder)!==null&&t!==void 0?t:y.value.placeholder}),X=dn(e,["items","options"]),q=[],D=T([]),G=T([]),Q=T(new Map),ie=k(()=>{const{fallbackOption:t}=e;if(t===void 0){const{labelField:u,valueField:x}=e;return B=>({[u]:String(B),[x]:B})}return t===!1?!1:u=>Object.assign(t(u),{value:u})}),ee=k(()=>G.value.concat(D.value).concat(X.value)),h=k(()=>{const{filter:t}=e;if(t)return t;const{labelField:u,valueField:x}=e;return(B,z)=>{if(!z)return!1;const P=z[u];if(typeof P=="string")return tt(B,P);const M=z[x];return typeof M=="string"?tt(B,M):typeof M=="number"?tt(B,String(M)):!1}}),v=k(()=>{if(e.remote)return X.value;{const{value:t}=ee,{value:u}=m;return!u.length||!e.filterable?t:qn(t,h.value,u,e.childrenField)}});function I(t){const u=e.remote,{value:x}=Q,{value:B}=O,{value:z}=ie,P=[];return t.forEach(M=>{if(B.has(M))P.push(B.get(M));else if(u&&x.has(M))P.push(x.get(M));else if(z){const Y=z(M);Y&&P.push(Y)}}),P}const W=k(()=>{if(e.multiple){const{value:t}=R;return Array.isArray(t)?I(t):[]}return null}),H=k(()=>{const{value:t}=R;return!e.multiple&&!Array.isArray(t)?t===null?null:I([t])[0]||null:null}),V=yn(e),{mergedSizeRef:E,mergedDisabledRef:j,mergedStatusRef:i}=V;function f(t,u){const{onChange:x,"onUpdate:value":B,onUpdateValue:z}=e,{nTriggerFormChange:P,nTriggerFormInput:M}=V;x&&ae(x,t,u),z&&ae(z,t,u),B&&ae(B,t,u),b.value=t,P(),M()}function A(t){const{onBlur:u}=e,{nTriggerFormBlur:x}=V;u&&ae(u,t),x()}function Z(){const{onClear:t}=e;t&&ae(t)}function se(t){const{onFocus:u,showOnFocus:x}=e,{nTriggerFormFocus:B}=V;u&&ae(u,t),B(),x&&de()}function Re(t){const{onSearch:u}=e;u&&ae(u,t)}function Fe(t){const{onScroll:u}=e;u&&ae(u,t)}function pe(){var t;const{remote:u,multiple:x}=e;if(u){const{value:B}=Q;if(x){const{valueField:z}=e;(t=W.value)===null||t===void 0||t.forEach(P=>{B.set(P[z],P)})}else{const z=H.value;z&&B.set(z[e.valueField],z)}}}function me(t){const{onUpdateShow:u,"onUpdate:show":x}=e;u&&ae(u,t),x&&ae(x,t),$.value=t}function de(){j.value||(me(!0),$.value=!0,e.filterable&&_e())}function te(){me(!1)}function we(){m.value="",G.value=q}const ce=T(!1);function Te(){e.filterable&&(ce.value=!0)}function ve(){e.filterable&&(ce.value=!1,p.value||we())}function ge(){j.value||(p.value?e.filterable?_e():te():de())}function Oe(t){var u,x;!((x=(u=C.value)===null||u===void 0?void 0:u.selfRef)===null||x===void 0)&&x.contains(t.relatedTarget)||(w.value=!1,A(t),te())}function ze(t){se(t),w.value=!0}function Me(t){w.value=!0}function ye(t){var u;!((u=F.value)===null||u===void 0)&&u.$el.contains(t.relatedTarget)||(w.value=!1,A(t),te())}function xe(){var t;(t=F.value)===null||t===void 0||t.focus(),te()}function oe(t){var u;p.value&&(!((u=F.value)===null||u===void 0)&&u.$el.contains(wn(t))||te())}function s(t){if(!Array.isArray(t))return[];if(ie.value)return Array.from(t);{const{remote:u}=e,{value:x}=O;if(u){const{value:B}=Q;return t.filter(z=>x.has(z)||B.has(z))}else return t.filter(B=>x.has(B))}}function g(t){K(t.rawNode)}function K(t){if(j.value)return;const{tag:u,remote:x,clearFilterAfterSelect:B,valueField:z}=e;if(u&&!x){const{value:P}=G,M=P[0]||null;if(M){const Y=D.value;Y.length?Y.push(M):D.value=[M],G.value=q}}if(x&&Q.value.set(t[z],t),e.multiple){const P=s(R.value),M=P.findIndex(Y=>Y===t[z]);if(~M){if(P.splice(M,1),u&&!x){const Y=Pe(t[z]);~Y&&(D.value.splice(Y,1),B&&(m.value=""))}}else P.push(t[z]),B&&(m.value="");f(P,I(P))}else{if(u&&!x){const P=Pe(t[z]);~P?D.value=[D.value[P]]:D.value=q}Be(),te(),f(t[z],t)}}function Pe(t){return D.value.findIndex(x=>x[e.valueField]===t)}function je(t){p.value||de();const{value:u}=t.target;m.value=u;const{tag:x,remote:B}=e;if(Re(u),x&&!B){if(!u){G.value=q;return}const{onCreate:z}=e,P=z?z(u):{[e.labelField]:u,[e.valueField]:u},{valueField:M}=e;X.value.some(Y=>Y[M]===P[M])||D.value.some(Y=>Y[M]===P[M])?G.value=q:G.value=[P]}}function Ke(t){t.stopPropagation();const{multiple:u}=e;!u&&e.filterable&&te(),Z(),u?f([],[]):f(null,null)}function Ue(t){!Ve(t,"action")&&!Ve(t,"empty")&&t.preventDefault()}function qe(t){Fe(t)}function Ie(t){var u,x,B,z,P;switch(t.key){case" ":if(e.filterable)break;t.preventDefault();case"Enter":if(!(!((u=F.value)===null||u===void 0)&&u.isComposing)){if(p.value){const M=(x=C.value)===null||x===void 0?void 0:x.getPendingTmNode();M?g(M):e.filterable||(te(),Be())}else if(de(),e.tag&&ce.value){const M=G.value[0];if(M){const Y=M[e.valueField],{value:Ee}=R;e.multiple&&Array.isArray(Ee)&&Ee.some(Ye=>Ye===Y)||K(M)}}}t.preventDefault();break;case"ArrowUp":if(t.preventDefault(),e.loading)return;p.value&&((B=C.value)===null||B===void 0||B.prev());break;case"ArrowDown":if(t.preventDefault(),e.loading)return;p.value?(z=C.value)===null||z===void 0||z.next():de();break;case"Escape":p.value&&(Mn(t),te()),(P=F.value)===null||P===void 0||P.focus();break}}function Be(){var t;(t=F.value)===null||t===void 0||t.focus()}function _e(){var t;(t=F.value)===null||t===void 0||t.focusInput()}function Ge(){var t;p.value&&((t=L.value)===null||t===void 0||t.syncPosition())}pe(),Se(J(e,"options"),pe);const Xe={focus:()=>{var t;(t=F.value)===null||t===void 0||t.focus()},blur:()=>{var t;(t=F.value)===null||t===void 0||t.blur()}},$e=k(()=>{const{self:{menuBoxShadow:t}}=c.value;return{"--n-menu-box-shadow":t}}),fe=d?He("select",void 0,$e,e):void 0;return Object.assign(Object.assign({},Xe),{mergedStatus:i,mergedClsPrefix:n,mergedBordered:o,namespace:l,treeMate:S,isMounted:un(),triggerRef:F,menuRef:C,pattern:m,uncontrolledShow:$,mergedShow:p,adjustedTo:it(e),uncontrolledValue:b,mergedValue:R,followerRef:L,localizedPlaceholder:U,selectedOption:H,selectedOptions:W,mergedSize:E,mergedDisabled:j,focused:w,activeWithoutMenuOpen:ce,inlineThemeDisabled:d,onTriggerInputFocus:Te,onTriggerInputBlur:ve,handleTriggerOrMenuResize:Ge,handleMenuFocus:Me,handleMenuBlur:ye,handleMenuTabOut:xe,handleTriggerClick:ge,handleToggle:g,handleDeleteOption:K,handlePatternInput:je,handleClear:Ke,handleTriggerBlur:Oe,handleTriggerFocus:ze,handleKeydown:Ie,handleMenuAfterLeave:we,handleMenuClickOutside:oe,handleMenuScroll:qe,handleMenuKeydown:Ie,handleMenuMousedown:Ue,mergedTheme:c,cssVars:d?void 0:$e,themeClass:fe==null?void 0:fe.themeClass,onRender:fe==null?void 0:fe.onRender})},render(){return r("div",{class:`${this.mergedClsPrefix}-select`},r(vn,null,{default:()=>[r(gn,null,{default:()=>r(Kn,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),r(bn,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===it.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>r(wt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,o;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),tn(r(Hn,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:"medium",renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(o=this.menuProps)===null||o===void 0?void 0:o.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var l,d;return[(d=(l=this.$slots).empty)===null||d===void 0?void 0:d.call(l)]},action:()=>{var l,d;return[(d=(l=this.$slots).action)===null||d===void 0?void 0:d.call(l)]}}),this.displayDirective==="show"?[[nn,this.mergedShow],[dt,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[dt,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{so as N};
