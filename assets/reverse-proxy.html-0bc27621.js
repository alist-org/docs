import{_ as d,M as r,X as l,P as a,$ as e,a5 as s,O as i,ai as t,G as c}from"./framework-1f2fdbd0.js";const o={},u=a("h1",{id:"反向代理",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#反向代理","aria-hidden":"true"},"#"),e(" 反向代理")],-1),p=t(`<h2 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx" aria-hidden="true">#</a> nginx</h2><p>在网站配置文件的 server 字段中添加</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>location / {
