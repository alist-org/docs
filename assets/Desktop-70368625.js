import{h as T,ax as pe,ay as Be,az as Ae,aA as Te,j as je,aB as Z,aC as Fe,aD as ee,K as N,a4 as ne,J as P,M as k,O as I,d as z,q as xe,a0 as Me,x as L,S as Ee,m as s,k as fe,l as H,g as x,s as oe,aE as Le,aF as He,aG as Ge,aH as Ue,A as ke,aI as te,aJ as Se,aK as ve,ah as We,H as qe,aL as Ve,aM as Je,aN as Qe,aO as Xe,aP as Ye,ak as Ze,y as O,aQ as eo,R as Ne,Y as ue,T as M,W as oo,aR as no,aS as to,aT as _e,aU as ro,av as be,o as io,F as ao,w as Q,a as X,u as E,e as me,I as we,N as lo,aw as so,_ as uo}from"./app-d342278e.js";import{N as co}from"./Icon-02e92254.js";import{C as po}from"./ChevronRight-072080dd.js";import{b as fo,N as ye}from"./Button-80ac2b83.js";import{N as ho}from"./Image-30e10c3e.js";function vo(e){return o=>{o?e.value=o.$el:e.value=null}}function bo(e,o,i){if(!o)return e;const r=T(e.value);let n=null;return pe(e,t=>{n!==null&&window.clearTimeout(n),t===!0?i&&!i.value?r.value=!0:n=window.setTimeout(()=>{r.value=!0},o):r.value=!1}),r}function mo(e={},o){const i=Be({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:r,keyup:n}=e,t=a=>{switch(a.key){case"Control":i.ctrl=!0;break;case"Meta":i.command=!0,i.win=!0;break;case"Shift":i.shift=!0;break;case"Tab":i.tab=!0;break}r!==void 0&&Object.keys(r).forEach(g=>{if(g!==a.key)return;const v=r[g];if(typeof v=="function")v(a);else{const{stop:S=!1,prevent:_=!1}=v;S&&a.stopPropagation(),_&&a.preventDefault(),v.handler(a)}})},c=a=>{switch(a.key){case"Control":i.ctrl=!1;break;case"Meta":i.command=!1,i.win=!1;break;case"Shift":i.shift=!1;break;case"Tab":i.tab=!1;break}n!==void 0&&Object.keys(n).forEach(g=>{if(g!==a.key)return;const v=n[g];if(typeof v=="function")v(a);else{const{stop:S=!1,prevent:_=!1}=v;S&&a.stopPropagation(),_&&a.preventDefault(),v.handler(a)}})},u=()=>{(o===void 0||o.value)&&(ee("keydown",document,t),ee("keyup",document,c)),o!==void 0&&pe(o,a=>{a?(ee("keydown",document,t),ee("keyup",document,c)):(Z("keydown",document,t),Z("keyup",document,c))})};return Ae()?(Te(u),je(()=>{(o===void 0||o.value)&&(Z("keydown",document,t),Z("keyup",document,c))})):u(),Fe(i)}const h="0!important",Pe="-1px!important";function W(e){return k(e+"-type",[P("& +",[N("button",{},[k(e+"-type",[I("border",{borderLeftWidth:h}),I("state-border",{left:Pe})])])])])}function q(e){return k(e+"-type",[P("& +",[N("button",[k(e+"-type",[I("border",{borderTopWidth:h}),I("state-border",{top:Pe})])])])])}const wo=N("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
`,[ne("vertical",{flexDirection:"row"},[ne("rtl",[N("button",[P("&:first-child:not(:last-child)",`
 margin-right: ${h};
 ...
 margin-right: ${h};
 border-radius: ${h};
 `),W("default"),k("ghost",[W("primary"),W("info"),W("success"),W("warning"),W("error")])])])]),k("vertical",{flexDirection:"column"},[N("button",[P("&:first-child:not(:last-child)",`
 margin-bottom: ${h};
 margin-left: ${h};
 margin-right: ${h};
 border-bottom-left-radius: ${h};
...
`,[Ye(),N("dropdown-option",`
 ...
 `,[I("prefix, suffix",`
 color: var(--n-option-text-color-hover);
 `),P("&::before","background-color: var(--n-option-color-hover);")]),k("active",`
 color: var(--n-option-text-color-active);
 `,[I("prefix, suffix",`
 color: var(--n-option-text-color-active);
 `),P("&::before","background-color: var(--n-option-color-active);")]),k("child-active",`
