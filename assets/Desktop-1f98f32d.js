import{h as A,ax as pe,ay as Be,az as Te,aA as Ae,j as je,aB as Z,aC as Fe,aD as ee,K as P,a4 as ne,J as R,M as S,O as I,d as z,q as xe,a0 as Me,x as L,S as Ee,m as s,k as fe,l as H,g,s as oe,aE as Le,aF as He,aG as Ge,aH as Ue,A as ke,aI as te,aJ as Se,aK as ve,ah as We,H as qe,aL as Ve,aM as Je,aN as Qe,aO as Xe,aP as Ye,ak as Ze,y as O,aQ as eo,R as Ne,Y as ue,T as M,W as oo,aR as no,aS as to,aT as Pe,aU as ro,av as be,o as io,F as ao,w as Q,a as X,u as E,e as me,I as we,N as lo,aw as so,_ as uo}from"./app-04883857.js";import{N as co}from"./Icon-2742675e.js";import{C as po}from"./ChevronRight-b083f441.js";import{b as fo,N as ye}from"./Button-9cd29ece.js";import{N as ho}from"./Image-6057ca9f.js";function vo(e){return o=>{o?e.value=o.$el:e.value=null}}function bo(e,o,i){if(!o)return e;const r=A(e.value);let n=null;return pe(e,t=>{n!==null&&window.clearTimeout(n),t===!0?i&&!i.value?r.value=!0:n=window.setTimeout(()=>{r.value=!0},o):r.value=!1}),r}function mo(e={},o){const i=Be({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:r,keyup:n}=e,t=a=>{switch(a.key){case"Control":i.ctrl=!0;break;case"Meta":i.command=!0,i.win=!0;break;case"Shift":i.shift=!0;break;case"Tab":i.tab=!0;break}r!==void 0&&Object.keys(r).forEach(y=>{if(y!==a.key)return;const h=r[y];if(typeof h=="function")h(a);else{const{stop:N=!1,prevent:_=!1}=h;N&&a.stopPropagation(),_&&a.preventDefault(),h.handler(a)}})},c=a=>{switch(a.key){case"Control":i.ctrl=!1;break;case"Meta":i.command=!1,i.win=!1;break;case"Shift":i.shift=!1;break;case"Tab":i.tab=!1;break}n!==void 0&&Object.keys(n).forEach(y=>{if(y!==a.key)return;const h=n[y];if(typeof h=="function")h(a);else{const{stop:N=!1,prevent:_=!1}=h;N&&a.stopPropagation(),_&&a.preventDefault(),h.handler(a)}})},u=()=>{(o===void 0||o.value)&&(ee("keydown",document,t),ee("keyup",document,c)),o!==void 0&&pe(o,a=>{a?(ee("keydown",document,t),ee("keyup",document,c)):(Z("keydown",document,t),Z("keyup",document,c))})};return Te()?(Ae(u),je(()=>{(o===void 0||o.value)&&(Z("keydown",document,t),Z("keyup",document,c))})):u(),Fe(i)}const v="0!important",_e="-1px!important";function W(e){return S(e+"-type",[R("& +",[P("button",{},[S(e+"-type",[I("border",{borderLeftWidth:v}),I("state-border",{left:_e})])])])])}function q(e){return S(e+"-type",[R("& +",[P("button",[S(e+"-type",[I("border",{borderTopWidth:v}),I("state-border",{top:_e})])])])])}const wo=P("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
