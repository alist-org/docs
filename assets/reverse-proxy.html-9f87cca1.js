import{_ as d,M as r,X as l,P as a,a0 as e,a6 as s,O as i,aj as t,G as c}from"./framework-f837dd26.js";const o={},u=a("h1",{id:"反向代理",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#反向代理","aria-hidden":"true"},"#"),e(" 反向代理")],-1),p=t(`<h2 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx" aria-hidden="true">#</a> nginx</h2><p>在网站配置文件的 server 字段中添加</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>location / {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="宝塔设置反向代理简单示范" tabindex="-1"><a class="header-anchor" href="#宝塔设置反向代理简单示范" aria-hidden="true">#</a> 宝塔设置反向代理简单示范</h2><p>首先新建一个站点，<strong>Alist启动程序</strong> 在不在这个站点文件夹内都无所谓，然后照着下图添加即可。</p><ul><li><mark>还有就是如果你要用宝塔开启 <strong>SSL(HTTPS)</strong>， 你需要在反向代理之前添加不然无法开启SSL</mark></li><li>如果你已经添加了反向代理，可以先停止 <strong>(图片里面哪个开启代理按钮关了它就行)</strong> ,开启了SSL再把反向代理打开即可</li></ul><p><img src="https://alist-doc.nn.ci/assets/images/BT-Proxy-5913c3786afba1417362c71f0af73ea9.png" alt="BT"></p>`,16);function v(m,h){const n=c("RouterLink");return r(),l("div",null,[u,a("p",null,[e("程序默认监听 5244 端口。如有修改，请一并修改下列配置中的端口号。如果你使用反向代理，建议你设置"),s(n,{to:"/zh/config/configuration.html#site_url"},{default:i(()=>[e("site_url")]),_:1}),e("，以帮助alist更好的工作。")]),a("blockquote",null,[a("p",null,[e("如果你想使用子目录，参考"),s(n,{to:"/zh/faq/howto.html#%E5%A6%82%E4%BD%95%E5%AF%B9%E5%AD%90%E7%9B%AE%E5%BD%95%E8%BF%9B%E8%A1%8C%E5%8F%8D%E5%90%91%E4%BB%A3%E7%90%86"},{default:i(()=>[e("这里")]),_:1})])]),p])}const x=d(o,[["render",v],["__file","reverse-proxy.html.vue"]]);export{x as default};
